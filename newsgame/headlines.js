...
function collectHeadlinesTest() {
    headlines = [
        ...
        ["Nancy Pelosi Calls Jamaal Bowman To Scold Him For Winning Primary", 3],
        ["Barack Obama and Joe Biden Join Forces in Video Targeting Trump", 2],
        ["CDC rolls out tools for schools to reopen safely during coronavirus outbreak: 'Critically important'", 1],
        ["A.O.C. Unleashes a Viral Condemnation of Sexism in Congress", 2],
        ["Kansas City mayor: 'Doxing' of police, officials should be criminalized", 1],
        ["Self-Loathing GOP Congressman Can’t Believe He’s Been Reduced To Defending Necessity Of Public Schools", 3],
        ["Timeline Of Presidential Polling", 3],
        ["Bloomberg's Everytown for Gun Safety Pours $15 Million Into Races in 8 States", 2]
    ];
